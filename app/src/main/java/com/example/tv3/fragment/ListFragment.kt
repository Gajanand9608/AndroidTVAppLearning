...
class ListFragment : RowsSupportFragment() {
    ...
    private var itemVideoSelectedListener: ((CommonDataModel) -> Unit)? = null
    private var itemVideoClickedListener : ((CommonDataModel) -> Unit)? = null
...
//        rootAdapter.add(listRow2)
    ...
    fun setOnVideoContentSelectedListener(listener : (CommonDataModel) -> Unit){
        this.itemVideoSelectedListener = listener
    }

    fun setOnVideoContentClickedListener(listener : (CommonDataModel) -> Unit){
